...
window.onload = function(){  
	...
	com.getData("../script/gambit.all.js",
		function(data){
		com.gambit=data.split(" ");
		AI.historyBill = com.gambit;
	})
	com.getData("../script/store.js",
		function(data){
...
com.loadImages = function(stype){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = "../image/"+stype+"/bg.png";
	
	//提示点
	com.dotImg = new Image();
	com.dotImg.src  = "../image/"+stype+"/dot.png";
	
	//棋子
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "../image/"+stype+"/"+ com.args[i].img +".png";
	}
	
	//棋子外框
	com.paneImg = new Image();
	com.paneImg.src  = "../image/"+stype+"/r_box.png";
	
	document.getElementsByTagName("body")[0].style.background= "url(../image/"+stype+"/bg.jpg)";
